...
export default function StreakContent({ onOpenAddActivity }: Props) {
  ...
  return (
    <div className="flex-1 bg-[#FFFFFF] p-8">
      {/* Search Bar */}
      <div className="w-full bg-[#F4F6F9] rounded-md px-6 py-3 shadow-sm mb-6 flex items-center">
        <input
          type="text"
      ...
      <div className="bg-[#F4F6F9] max-w-500 mx-auto rounded-md p-6">
        {/* Table */}
        <div className="bg-[#F4F6F9] space-y-3 max-h-[430px] overflow-y-auto min-h-fit rounded-md shadow-sm overflow-hidden">
        ...
        {/* Bottom Button (OPEN SIDEBAR) */}
        <div
          onClick={() => setOpenAdd(true)}
          className="bg-[#F4F6F9] mt-8 rounded-xl px-6 py-3 shadow-sm flex items-center gap-2 text-sm text-gray-600 italic cursor-pointer hover:bg-gray-100 transition"
        >
